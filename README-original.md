# Vencord with Russian Localization

This is a fork of [Vencord](https://github.com/Vendicated/Vencord) that adds full Russian language support.

[Русская версия README](README.ru.md)

## Features

- 🌐 Complete Russian localization of the Vencord interface
- 🔌 Translation of main plugins and their settings
- 🔄 Automatic detection of Discord language
- 🌍 Option to select language independently from Discord settings

## Installation

### Method 1: Using pre-built release

1. Download the latest release from the [releases page](https://github.com/yourusername/vencord-russian/releases)
2. Extract the archive
3. Run `VencordInstallerCli.exe`
4. Select the Discord version to patch
5. Restart Discord
...
5. Select the Discord version to patch and press Enter
6. Restart Discord
...
2. Scroll down to the "Vencord" section
3. Go to the "Vencord Language" tab
4. Select "Русский" from the dropdown menu
5. The page will automatically reload with Russian language applied

### Automatic Language Detection

If your Discord is already set to Russian, Vencord will automatically use Russian for its interface. You can always change this in the settings.

## Contributing

If you want to help with translation or improve existing translations:

1. Fork the repository
2. Make changes to the translation files:
   - `src/utils/i18n.ts` - main interface translations
   - `src/utils/pluginsTranslations.ts` - plugin translations
3. Create a Pull Request with your changes

## License

This project is licensed under the same license as the original Vencord - [GNU General Public License v3.0](LICENSE).

## Acknowledgments

- [Vencord Team](https://github.com/Vendicated/Vencord) for creating an excellent Discord modification
- All contributors helping with translation
